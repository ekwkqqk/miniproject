...
import { THEMED_DIALOG_CLASS } from '@/shared/utils/dialog'
...
const props = defineProps({
  ...
  /**
   * 헤더 테마색 적용 (기본 true).
   * 개별 지정 대신 themedDialogProps() / 이 기본값을 사용한다.
   */
  themedHeader: { type: Boolean, default: true },
})
...
const dialogClass = computed(() => [
  'responsive-dialog',
  props.themedHeader ? THEMED_DIALOG_CLASS : '',
